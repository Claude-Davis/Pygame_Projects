...
surf1.fill(color=(0,255,0))      # COLORING; creates a green square in the top left corner of the 

surf2 = pygame.Surface((100,100))        # establishes the size of the surface ((width, height))
surf2.fill(color=(255,0,0))      # COLORING; creates a red square in the top left corner of the
